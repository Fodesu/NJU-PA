...
word_t paddr_read(paddr_t addr, int len) {
  // if(CONFIG_MTRACE) Log("paddr read the " FMT_PADDR ASNI_FMT(" at pc = " FMT_PADDR, ASNI_FG_WHITE), addr, cpu.pc);
...
void paddr_write(paddr_t addr, int len, word_t data) {
  // if(CONFIG_MTRACE) Log("paddr write the " FMT_PADDR ASNI_FMT(" at pc = " FMT_PADDR, ASNI_FG_WHITE), addr, cpu.pc);
